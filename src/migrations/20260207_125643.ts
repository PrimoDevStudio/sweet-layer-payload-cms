...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_allergens" AS ENUM('wheat', 'dairy', 'eggs', 'nuts', 'soy', 'peanuts');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'confirmed', 'processing', 'ready', 'delivering', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_orders_delivery_method" AS ENUM('pickup', 'delivery');
  CREATE TYPE "public"."enum_posts_category" AS ENUM('recipes', 'tips', 'announcements', 'behind-the-scenes');
  ...
  CREATE TABLE "categories" (
  	...
  	"description" varchar,
  	"image_id" integer,
  	"color" varchar DEFAULT '#d4a5a5' NOT NULL,
  	"icon" varchar,
